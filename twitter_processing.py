...
tweets_filename = 'twitter_stream_10000tweets.txt'
...
t3 = np.arange(1, len(geoList) + 1, 1)

plt.figure(1)
plt.plot(t1, sorted(langList.values(), reverse=True), 'ro')
plt.annotate('English', xy=(1, 3135), xytext=(5, 3135), arrowprops=dict(facecolor='black', shrink=0.05))
plt.annotate('Arabic', xy=(2, 1042), xytext=(6, 1042), arrowprops=dict(facecolor='black', shrink=0.05))
plt.annotate('Spanish', xy=(3, 971), xytext=(7, 971), arrowprops=dict(facecolor='black', shrink=0.05))
...
plt.annotate('English', xy=(1, 3115), xytext=(7, 3115), arrowprops=dict(facecolor='black', shrink=0.05))
plt.annotate('Arabic', xy=(2, 973), xytext=(8, 973), arrowprops=dict(facecolor='black', shrink=0.05))
plt.annotate('Spanish', xy=(3, 874), xytext=(9, 874), arrowprops=dict(facecolor='black', shrink=0.05))
...
plt.figure(3)
plt.plot(geoList.values(), t3, '^')
plt.hlines(t3, [0], geoList.values(), lw=2)
plt.xlabel('fraction')
plt.ylabel('countries')
plt.yticks(t3, geoList.keys())
